...
const PackageTable = <T extends object>({
  ...
  return (
    <div className="flex flex-col gap-[20px]">
      <div className="flex w-full flex-col gap-[10px] overflow-hidden rounded-[20px] border border-gray-200 bg-white">
        <div className="h-max overflow-auto">
          ...
          <div className="grid grid-cols-4 items-end gap-[20px]  bg-neutral-50 px-[30px] py-[10px] [&>tr>td]:border-0 [&>tr>td]:p-0">
            {tableFooter}
          </div>
        </div>
      </div>
